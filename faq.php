...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div>
      ...
      <p>Si se realizó el pago con Tarjeta de Débito o Crédito la acreditación es instantánea. En caso que el pago se realice en Efectivo (Rapipago/PagoFacil) o Transferencia, una vez realizado hay tiepo hasta 72hs hábiles para poder pagarlo. En caso de no recibir pago la plataforma cancela automáticamente el pedido.</p>
      <h6 class="pregunta"><strong>¿Cómo se realiza el envío y cuál es el costo?</strong></h6>
      <p>El envío se realiza por OCA y el costo del envio depende del domicilio de entrega y se detalla antes de finalizar la compra. El envio gratuito es a partir de $2000.</p>
      ...
      <p>En caso de no retirar el pedido dentro de los 4 o 5 días hábiles desde que el pedido está disponible para su retiro en OCA, el pedido vuelve al remitente. Esto demora unos dias (aproximadamente una semana), y se deberá reprogramar el envío. El costo de este envío debe ser abonado nuevamente.</p>
      <h6 class="pregunta"><strong>¿Cómo se realiza el seguiemiento del pedido? </strong></h6>
