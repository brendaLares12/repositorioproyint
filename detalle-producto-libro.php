    ...
    <div class="detalle-productos">
      <div>
        ...
        <div class="container-detalle">
          <div class="col-md-4">
            <div class="tomsawyer">
              <a href=#><img src="img/tomsawyer.jpg" alt="" height="400px"></a>
              <br>
              <br>
            </div>
          </div>
          <div class="col-md-6">
            <div>
              <p><strong>"Las Aventuras de Tom Sawyer"</strong>
                <p />
            </div>
            <ul>
      ...
      <div>
        ...
        <div class="container-detalle">
          ...
          <div class="col-md-6">
            <div>
              <p><strong>Lápices "Faber Castell" Grip Triangulares X 24</strong>
                <p />
            </div>
            <ul>
      ...
      <div>
        ...
        <div class="container-detalle">
          ...
          <div class="col-md-6">
            <div>
              <p><strong>Mochilas para niños y niñas</strong>
                <p />
            </div>
            <ul>
